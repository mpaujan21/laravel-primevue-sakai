...
import { Button, ButtonGroup, SplitButton } from 'primevue';
        ...
        <div class="flex flex-col gap-8 md:flex-row">
            ...
            <div class="md:w-1/2">
                ...
                <div class="flex flex-col gap-4 card">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <Button type="button" class="mb-2 mr-2" label="Search" icon="pi pi-search" :loading="loading[0]"
                            @click="load(0)" />
                        <Button type="button" class="mb-2 mr-2" label="Search" icon="pi pi-search" iconPos="right"
                            :loading="loading[1]" @click="load(1)" />
                        <Button type="button" class="mb-2 mr-2" icon="pi pi-search" :loading="loading[2]"
                            @click="load(2)" />
