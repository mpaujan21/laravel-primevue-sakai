...
import { Button, Checkbox, Column, DataTable, DatePicker, IconField, InputIcon, InputNumber, InputText, MultiSelect, ProgressBar, Rating, Select, Slider, Tag, ToggleButton } from 'primevue';
        ...
        <div class="card">
            ...
            <DataTable :value="customers3" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single"
                ...
                <template #groupfooter="slotProps">
                    <div class="flex justify-end w-full font-bold">Total Customers: {{
