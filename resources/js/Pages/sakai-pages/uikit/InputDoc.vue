...
import { AutoComplete, Button, Checkbox, ColorPicker, DatePicker, FloatLabel, Fluid, IconField, InputGroup, InputGroupAddon, InputIcon, InputNumber, InputText, Knob, Listbox, MultiSelect, RadioButton, Rating, Select, SelectButton, Slider, Textarea, ToggleButton, ToggleSwitch, TreeSelect } from 'primevue';
                ...
                <div class="flex flex-col gap-4 card">
                    ...
                    <MultiSelect v-model="multiselectValue" :options="multiselectValues" optionLabel="name"
                        ...
                        <template #value="slotProps">
                            <div class="inline-flex items-center px-2 py-1 mr-2 bg-primary text-primary-contrast rounded-border"
