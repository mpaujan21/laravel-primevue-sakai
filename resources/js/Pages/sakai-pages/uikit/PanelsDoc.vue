...
import { Accordion, AccordionContent, AccordionHeader, AccordionPanel, Button, Card, Divider, Fieldset, IconField, InputIcon, InputText, Menu, Panel, SplitButton, Splitter, SplitterPanel, Tab, TabList, TabPanel, TabPanels, Tabs, Toolbar } from 'primevue';
        ...
        <div class="flex flex-col">
            ...
            <div class="mt-8 card">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col items-center justify-center w-full gap-3 py-5 md:w-5/12">
                    ...
                    <div class="flex items-center justify-center w-full py-5 md:w-5/12">
