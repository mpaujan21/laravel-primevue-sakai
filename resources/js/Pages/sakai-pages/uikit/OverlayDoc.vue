...
import { Button, Column, ConfirmPopup, DataTable, Dialog, Drawer, InputText, Popover } from 'primevue';
        ...
        <div class="flex flex-col gap-8 md:flex-row">
                ...
                <div class="card">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <Popover ref="op2" id="overlay_panel" style="width: 450px">
                            <DataTable v-model:selection="selectedProduct" :value="products" selectionMode="single"
                                :paginator="true" :rows="5" @row-select="onProductSelect">
            ...
            <div class="md:w-1/2">
                ...
                <div class="card">
                    ...
                    <Button ref="popup" @click="confirm($event)" icon="pi pi-check" label="Confirm"
                        class="mr-2"></Button>
                </div>

                <div class="card">
                    <div class="mb-4 text-xl font-semibold">ConfirmDialog</div>
                    <Button label="Delete" icon="pi pi-trash" severity="danger" style="width: auto"
                        @click="openConfirmation" />
                    <Dialog header="Confirmation" v-model:visible="displayConfirmation" :style="{ width: '350px' }"
                        :modal="true">
                        <div class="flex items-center justify-center">
                            <i class="mr-4 pi pi-exclamation-triangle" style="font-size: 2rem" />
                            <span>Are you sure you want to proceed?</span>
                        </div>
                        <template #footer>
                            <Button label="No" icon="pi pi-times" @click="closeConfirmation" text
                                severity="secondary" />
                            <Button label="Yes" icon="pi pi-check" @click="closeConfirmation" severity="danger" outlined
                                autofocus />
                        </template>
                    </Dialog>
                </div>
