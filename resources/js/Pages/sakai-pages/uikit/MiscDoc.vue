...
import { Avatar, AvatarGroup, Badge, Button, Chip, OverlayBadge, ProgressBar, ScrollPanel, ScrollTop, Skeleton, Tag } from 'primevue';
        ...
        <div class="flex flex-col gap-8 md:flex-row">
            <div class="md:w-1/2">
                ...
                <div class="card">
                    ...
                    <Avatar label="V" class="mr-2" size="large"
                        :style="{ 'background-color': '#2196F3', color: '#ffffff' }" shape="circle"></Avatar>
                ...
                <div class="card">
                    ...
                    <ScrollPanel :style="{ width: '250px', height: '200px' }">
                        <p>
                            ...
                            adipiscing elit ut. Nam libero justo laoreet sit amet. Pharetra massa massa ultricies mi
                            quis hendrerit dolor magna. Est ultricies integer quis auctor elit sed vulputate. Consequat
                            ac felis donec et. Tellus orci ac auctor
                            augue mauris. Semper feugiat nibh sed pulvinar proin gravida hendrerit lectus a. Tincidunt
                            arcu non sodales neque sodales. Metus aliquam eleifend mi in nulla posuere sollicitudin
                            aliquam ultrices. Sodales ut etiam sit amet
                            nisl purus. Cursus sit amet dictum sit amet. Tristique senectus et netus et malesuada fames
                            ac turpis egestas. Et tortor consequat id porta nibh venenatis cras sed. Diam maecenas
                            ultricies mi eget mauris. Eget egestas purus
            ...
            <div class="md:w-1/2">
                ...
                <div class="card">
                    ...
                    <div class="flex flex-col items-center sm:flex-row">
                        <Chip label="Amy Elsner" :image="'/demo/images/avatar/amyelsner.png'" class="mb-2 mr-2"></Chip>
                ...
                <div class="card">
                    ...
                    <div class="p-6 border rounded-border border-surface">
                        <div class="flex mb-4">
