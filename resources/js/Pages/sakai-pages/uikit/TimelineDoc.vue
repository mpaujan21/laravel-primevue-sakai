        ...
        <div class="grid grid-cols-12 gap-8">
                ...
                <div class="card">
                    ...
                    <Timeline :value="events" align="alternate" class="customized-timeline">
                        <template #marker="slotProps">
                            <span
                                class="z-10 flex items-center justify-center w-8 h-8 text-white rounded-full shadow-sm"
                            ...
                            <Card class="mt-4">
                                ...
                                <template #content>
                                    <img v-if="slotProps.item.image"
                                        ...
                                        :alt="slotProps.item.name" width="200" class="shadow-sm" />
                                    <p>
            ...
            <div class="col-span-full">
                <div class="card">
                    ...
                    <div class="mt-4 mb-2 font-semibold">Bottom Align</div>
                    ...
                    <div class="mt-4 mb-2 font-semibold">Alternate Align</div>
